      ...
      <div className="relative isolate -z-10">
        ...
        >
          <div
            ...
            className="relative aspect-[1155/678] -translate-x-1/2 rotate-[210deg] bg-gradient-to-tr from-[#f97316] to-[#9089fc] opacity-40 left-[calc(50%)-1/2] w-[36.125rem] sm:w-[72.1875rem] "
          />
        </div>
      </div>
    </div>
