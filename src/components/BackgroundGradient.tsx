      ...
      <div className="relative isolate">
        ...
        >
          <div
            ...
            className="relative aspect-[1155/678] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-40 left-[calc(50%)] w-[36.125rem] sm:w-[72.1875rem] "
          />
        </div>
      </div>
    </div>
